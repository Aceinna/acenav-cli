...
class Provider(OpenDeviceBase):
    ...
    def prepare_folders(self):
        ...
        all_products = {'INS502':['RTK_INS']}
        config_file_mapping = {'INS502':'ins502.yml'}
    ...
    def after_setup(self):
        ...
        try:
            if self.data_folder:
                ...
                self.log_file_path = file_name + '/' + 'user_' + file_time + '.bin'
                self.user_logf = open(self.log_file_path, "wb")
                self.rtcm_logf = open(
